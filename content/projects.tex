...
\nopagebreak		& Thematik	    & Aufbau einer Big Data - Architektur zur Verarbeitung von Fahrzeugdaten in der Cloud\\
\nopagebreak		& Rolle 	    & Software Architekt, Docker Spezialist\\
\nopagebreak		& Technologien	& Akka, AWS, CloudFormation, Cassandra, DC/OS, Docker, ELK, Kafka, Marathon, Mesos, Mosquitto (MQTT), Terraform, Scala, Zeppelin, Zookeeper\\
\\
